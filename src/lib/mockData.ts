...
export const MOCK_SHOP_ITEMS: ShopItem[] = [
  // SKINS
  { id: 's1', name: 'Cuy Gamer', description: 'Skin gamer con lentes y audífonos. Perfecto para los que viven pegados a la pantalla.', icon: '🐹', category: 'skin', price_coins: 500, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/88ab4c3a-01d1-41c4-b17e-2e84faabf6ed/_result.png', rarity: 'common' },
  { id: 's2', name: 'Cuy Dorado', description: 'Skin dorada legendaria. Brilla con luz propia en cada partida.', icon: '🐹', category: 'skin', price_coins: 2000, price_gems: 50, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/a10a7b6c-a6e8-4a96-99a6-ed451da3f033/_result.png', rarity: 'legendary' },
  { id: 's3', name: 'Cuy Cyberpunk', description: 'Skin futurista con luces de neón. Para los amantes del futuro.', icon: '🐹', category: 'skin', price_coins: 1500, price_gems: 30, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/1a9a7a35-400d-4b78-a880-0247f3368945/_result.png', rarity: 'epic' },
  { id: 's8', name: 'Cuy Samurai', description: 'Skin samurái épica. Honor y matemáticas en cada movimiento.', icon: '🐹', category: 'skin', price_coins: 1800, price_gems: 40, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/e30ef96a-31cb-49e5-8ea7-1dccc0c93f14/_result.png', rarity: 'epic' },
  // MASCOTS
  { id: 's4', name: 'Llama Blanca', description: 'Mascota compañera fiel. Te acompaña en cada desafío.', icon: '🦙', category: 'pet', price_coins: 800, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/4008da11-eb13-4253-b822-7c6ddae70000/_result.png', rarity: 'rare' },
  { id: 's11', name: 'Cuy Matemático', description: 'Tu compañero de estudio. Siempre listo con una pista.', icon: '🐹', category: 'pet', price_coins: 650, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/006bfac9-68a0-4b22-8ce8-5aa78504e096/_result.png', rarity: 'common' },
  // BACKGROUNDS
  { id: 's5', name: 'Fondo Espacial', description: 'Galaxias, planetas y símbolos matemáticos flotando en el cosmos.', icon: '🌌', category: 'background', price_coins: 600, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/3468e72c-4148-4f9a-8565-9bc4c720942d/_result.png', rarity: 'rare' },
  { id: 's7', name: 'Fondo Neón', description: 'Estilo cyberpunk con ecuaciones brillantes. Futuro puro.', icon: '💜', category: 'background', price_coins: 700, price_gems: 15, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/2f848f42-dfbb-47e8-ae21-15fdae7d3843/_result.png', rarity: 'epic' },
  { id: 's9', name: 'Fondo Matemático', description: 'Formas geométricas y ecuaciones en movimiento. Clásico y elegante.', icon: '📐', category: 'background', price_coins: 550, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/f9b90eb8-0f91-4f1a-9fe1-4c3525451032/_result.png', rarity: 'common' },
  { id: 's10', name: 'Fondo Naturaleza', description: 'Bosque educativo con luz solar. Aprende en calma.', icon: '🌿', category: 'background', price_coins: 500, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/52ebb24b-1a72-466e-a214-e74ee4affcdc/_result.png', rarity: 'common' },
  { id: 's12', name: 'Fondo Cyberpunk', description: 'Ciudad futurista con luces de neón. Para mentes avanzadas.', icon: '🏙️', category: 'background', price_coins: 750, price_gems: 20, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/3838c3e9-8120-43d7-97ec-07a667e57bbb/_result.png', rarity: 'epic' },
  // EFFECTS
  { id: 's6', name: 'Efecto Rayo', description: 'Relámpago eléctrico al acertar. Impacto visual garantizado.', icon: '⚡', category: 'effect', price_coins: 400, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/8d249a42-f3a4-44a0-9f36-8a228ac0d6e6/_result.png', rarity: 'common' },
  { id: 's13', name: 'Efecto Partículas', description: 'Sparkles mágicos al completar racha. Puro estilo.', icon: '✨', category: 'effect', price_coins: 450, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/e262b386-5b7d-47b9-abc1-8e5f1841a175/_result.png', rarity: 'rare' },
  { id: 's14', name: 'Efecto Confeti', description: 'Celebración colorida al ganar. Fiesta en pantalla.', icon: '🎉', category: 'effect', price_coins: 500, price_gems: null, is_premium: false, image_url: 'https://image.qwenlm.ai/generated-images/11169b5e-b6be-4d64-868c-a99254227896/_result.png', rarity: 'rare' },
  { id: 's15', name: 'Explosión Matemática', description: 'Números y ecuaciones explotando. Efecto épico.', icon: '💥', category: 'effect', price_coins: 900, price_gems: 20, is_premium: true, image_url: 'https://image.qwenlm.ai/generated-images/f66c16e6-e970-4be8-b73a-782a84f1c81f/_result.png', rarity: 'epic' },
];
